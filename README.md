### ["Практика минипроекты JavaScript" (Преподаватель: Трепачёв Дмитрий, автор сайта code.mu)](https://cyberpunk10.github.io/Practics-JS_code.mu "Практика минипроекты JavaScript, перейти на сайт")
