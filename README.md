### ["Практика минипроекты JavaScript" (Преподаватель: Трепачёв Дмитрий, автор сайта code.mu)](https://cyberpunk10.github.io/003_Practics-JS_code.mu "Практика минипроекты JavaScript, перейти на сайт")
